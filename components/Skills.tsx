...
import { MousePointer2, Languages, Users, MessageCircle } from "lucide-react";
...
const PhotoshopLogo = memo(({ className }: { className?: string }) => (
  <img src="/ps.svg" alt="Photoshop" className={className} />
));
PhotoshopLogo.displayName = "PhotoshopLogo";
    ...
    return (
      <div className="w-full mt-auto pt-4">
        <div className="flex justify-between items-end mb-2">
          <span className="font-display text-[11px] font-bold text-gray-500 tracking-widest uppercase">
            Proficiency
          </span>
          <div className="flex items-baseline">
            <motion.span className="font-display text-2xl font-black text-white leading-none tracking-tight">
              {rounded}
            </motion.span>
...
const Card = memo(
  ({
    ...
    <motion.div
      ...
      className={cn(
        "relative flex flex-col p-5 rounded-[24px] bg-white/5 border border-white/10 shadow-[0_4px_20px_rgba(0,0,0,0.2)] transition-all duration-500 hover:shadow-[0_16px_32px_rgba(0,0,0,0.4)] hover:bg-white/10 hover:-translate-y-1 overflow-hidden group h-full min-h-[320px] md:min-h-0 gpu-accelerated backdrop-blur-sm",
        className,
      )}
    >
      {children}
...
const FigmaVisual = memo(() => (
  <div className="relative h-24 w-full my-3 border border-dashed border-white/20 rounded-xl flex items-center justify-center bg-white/5 group-hover:bg-white/10 transition-colors overflow-hidden">
    <motion.div
      className="absolute flex gap-2"
      animate={{ x: [0, 10, 0, -10, 0], y: [0, -5, 0, 5, 0] }}
      transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
    >
      <div className="w-16 h-20 bg-white/10 rounded-lg shadow-sm border border-white/20 p-2 flex flex-col gap-1">
        <div className="w-full h-8 bg-purple-500/30 rounded-md" />
    ...
    <span className="absolute bottom-2 left-3 text-[10px] font-bold text-gray-400 uppercase tracking-widest bg-black/30 px-2 py-0.5 rounded-full backdrop-blur-sm">
      Auto Layout
    </span>
  </div>
));
...
const IllustratorVisual = memo(() => (
  <div className="relative h-24 w-full my-3 border border-white/10 rounded-xl overflow-hidden bg-white/5 group-hover:border-white/20 transition-colors">
    ...
    <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent pointer-events-none" />
    <span className="absolute bottom-2 left-3 text-[10px] font-bold text-gray-400 uppercase tracking-widest bg-black/30 px-2 py-0.5 rounded-full backdrop-blur-sm z-10 shadow-sm">
      Vector Path
    </span>
  </div>
));
...
const PhotoshopVisual = memo(() => (
  <div className="relative h-24 w-full my-3 border border-dashed border-white/20 rounded-xl flex items-center justify-center bg-white/5 group-hover:bg-white/10 transition-colors overflow-hidden">
    ...
    >
      <div className="w-20 h-16 bg-gradient-to-br from-blue-500/30 to-cyan-500/20 rounded-lg border border-white/20 flex items-center justify-center">
        <div className="w-12 h-10 bg-white/10 rounded border border-white/10" />
      </div>
    </motion.div>
    <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent pointer-events-none" />
    <span className="absolute bottom-2 left-3 text-[10px] font-bold text-gray-400 uppercase tracking-widest bg-black/30 px-2 py-0.5 rounded-full backdrop-blur-sm">Photo Edit</span>
  </div>
));

PhotoshopVisual.displayName = "PhotoshopVisual";
    ...
    <div className="w-full min-h-full flex flex-col items-center p-4 md:p-6 lg:p-8 overflow-visible pb-20">
      <div className="text-center mb-8 md:mb-10 shrink-0 relative z-10 mt-2">
        <motion.h2
          ...
          className="text-2xl md:text-3xl lg:text-4xl font-display font-bold text-white tracking-tight flex items-baseline justify-center gap-2"
        >
          My
          <div className="relative inline-block">
            <span className="font-designer font-normal text-3xl md:text-4xl lg:text-5xl relative z-10">
              Skills
            </span>
            <svg
      ...
      <div className="w-full max-w-[1400px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 items-stretch">
        ...
        <Card className="justify-between" index={2}>
          <div>
            ...
            <h3 className="text-xl font-bold text-white mb-0.5">Illustrator</h3>
        ...
        <Card className="justify-between" index={3}>
          <div>
            <div className="flex justify-between items-start mb-3">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center group-hover:scale-105 transition-transform duration-500 overflow-hidden shadow-sm">
                <PhotoshopLogo className="w-full h-full" />
              </div>
              <div className="px-2 py-1 bg-blue-500/20 rounded-md border border-blue-400/30">
            ...
            <h3 className="text-xl font-bold text-white mb-0.5">Photoshop</h3>
            <p className="text-sm text-gray-400 leading-relaxed">
              Photo manipulation, compositing, and digital retouching.
            </p>
      ...
      <motion.div
        ...
        className="w-full max-w-[1400px] mt-10"
      >
        <div className="text-center mb-6">
           <motion.h2
          initial={{ opacity: 0, y: 15 }}
          animate={{ opacity: 1, y: 0 }}
          className="text-2xl md:text-3xl lg:text-4xl capitalize font-display font-bold text-white tracking-tight flex items-baseline justify-center gap-2"
        >
          soft
          <div className="relative inline-block">
            <span className="font-designer font-normal text-3xl md:text-4xl lg:text-5xl relative z-10">
          ...
          <p className="text-gray-500 text-sm mt-1">Soft skills that amplify my work</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <motion.div
            ...
            className="relative p-5 rounded-2xl bg-gradient-to-br from-emerald-500/10 to-teal-500/5 border border-emerald-500/20 backdrop-blur-sm group hover:border-emerald-400/40 transition-all duration-300"
          >
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="px-3 py-1.5 bg-emerald-500/20 rounded-full border border-emerald-400/30">
                <span className="text-xs font-bold text-emerald-400">C1 Level</span>
              </div>
            </div>
            <h4 className="text-lg font-bold text-white mb-1">English</h4>
            <p className="text-sm text-gray-400 leading-relaxed">
              Advanced proficiency enabling seamless international collaboration and clear documentation.
            </p>
            <div className="mt-4 flex gap-2">
              {["Speaking", "Writing", "Reading"].map((skill) => (
                <span key={skill} className="text-[10px] font-medium text-emerald-400/80 bg-emerald-500/10 px-2 py-1 rounded-full">
                  {skill}
                </span>
              ))}
            </div>
          ...
          <motion.div
            ...
            className="relative p-5 rounded-2xl bg-gradient-to-br from-amber-500/10 to-orange-500/5 border border-amber-500/20 backdrop-blur-sm group hover:border-amber-400/40 transition-all duration-300"
          >
            <div className="flex items-start justify-between mb-4">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              Guiding teams with vision, fostering growth, and driving projects to successful completion.
            </p>
            <div className="mt-4 flex gap-2">
          ...
          <motion.div
            ...
            className="relative p-5 rounded-2xl bg-gradient-to-br from-violet-500/10 to-purple-500/5 border border-violet-500/20 backdrop-blur-sm group hover:border-violet-400/40 transition-all duration-300"
          >
            <div className="flex items-start justify-between mb-4">
            ...
            <h4 className="text-lg font-bold text-white mb-1">Communication</h4>
            <p className="text-sm text-gray-400 leading-relaxed">
              Articulating ideas clearly, active listening, and bridging gaps between teams and stakeholders.
            </p>
            <div className="mt-4 flex gap-2">
